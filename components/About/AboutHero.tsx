        ...
        <div className="max-w-7xl mx-auto min-h-[60vh] py-8 px-4">
            <div className="grid grid-cols-1 h-full min-h-[60vh] md:grid-cols-2 gap-6">
                <div className="w-full h-full flex flex-col justify-center">
                    <h1 className="text-2xl md:text-4xl lg:text-5xl text-gray-700"><span className="pl-2 font-bold">About Us</span></h1>
                ...
                <div className="w-full h-full grid grid-cols-3 gap-3 lg:gap-6">
                    ...
                    <div className="h-full flex items-center">
                        <img src="/images/spa.jpg" alt="youth" className="h-3/4 w-full object-cover rounded-xl shadow-lg " />
                    </div>
                </div>
            </div>
        </div>
