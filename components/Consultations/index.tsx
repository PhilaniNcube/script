    ...
    <Fragment>
      <div className="max-w-7xl mx-auto py-16 px-4">
        ...
        <p className="text-gray-400 text-lg md:text-xl font-medium">
          Online services and consultations provided to online customers
        </p>
          ...
          <div className="col-span-1 md:col-span-3 z-10 min-h-[60vh] md:row-start-1 md:col-start-1 flex items-center">
            <div className="max-h-[40vh] flex flex-col justify-center h-full z-20 backdrop-blur-sm my-auto w-full rounded-xl bg-slate-100/50 shadow-md p-4">
              <h3 className="text-lg md:text-xl text-gray-700 font-bold">
                Find great products promoted by your favourite creators
              </h3>
              <p className="text-sm md:text-base text-gray-900 font-medium">
                Online services and consultations provided to online customers
                through interactive digital content, created by our digital
                entrepreneurs.
              </p>
            </div>
          </div>
